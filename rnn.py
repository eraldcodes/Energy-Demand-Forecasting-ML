...
# Reshape input to fit RNN requirements
X_train_reshaped = X_train.values.reshape((X_train.shape[0], X_train.shape[1], 1))

# RNN Model
model = Sequential()
model.add(SimpleRNN(50, input_shape=(X_train_reshaped.shape[1], 1), return_sequences=False))
...
new_csv_file_path = '/content/drive/MyDrive/ColabNotebooks/lstm/predicted_data_rnn_model_scenario.csv'
