...
new_csv_file_path = '/content/drive/MyDrive/ColabNotebooks/lstm/predicted_data_lstm_cnn_model_scenario_9.csv'
test_data_aligned.to_csv(new_csv_file_path, index=False)

print(f""Scenario 9 Predictions saved to {new_csv_file_path}"")"
