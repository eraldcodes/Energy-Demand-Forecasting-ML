...
# GRU Model
model = Sequential()
model.add(GRU(units=64, return_sequences=True, input_shape=(X_train_reshaped.shape[1], 1)))
...
new_csv_file_path = '/content/drive/MyDrive/ColabNotebooks/lstm/predicted_data_gru_model_scenario.csv'
